...
public class AppDbContext : DbContext
{
    ...
    public DbSet<Advice.Domain.Models.Advice> Advices { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<Advice.Domain.Models.Advice>().ToTable("Advices");
        builder.Entity<Advice.Domain.Models.Advice>().HasKey(p => p.Id);
        builder.Entity<Advice.Domain.Models.Advice>().Property(p => p.Id).IsRequired().ValueGeneratedOnAdd();
        builder.Entity<Advice.Domain.Models.Advice>().Property(p => p.strAdvice).IsRequired();
        builder.Entity<Advice.Domain.Models.Advice>().Property(p => p.strAdviceThumb).IsRequired();
        builder.Entity<Advice.Domain.Models.Advice>().Property(p => p.strAdviceCategory).IsRequired();
        builder.Entity<Advice.Domain.Models.Advice>().Property(p => p.strAdviceDescription).IsRequired();
